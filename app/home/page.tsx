...
const CATEGORY_CARDS: { label: string; filter: string; c1: string; image?: string }[] = [
  { label: "Funko Pops", filter: "Funko Pops", c1: "#7A1F24", image: "https://i.ibb.co/PZhgBTRP/Funkologo.jpg" },
  {
